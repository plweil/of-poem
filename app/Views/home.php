...
if ($poem): ?>
  <main class="content">
    ...
    <div class="page-intro">
      ...
      <p>This site presents a new <cite>Of Poem</cite>: a selection drawn from both the original anthology and the later work of James Weil, as both poet and publisher. It includes poems by writers he published and admired—among them
